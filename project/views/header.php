        ...
        <nav class="navbar navbar-dark" style="background-color: #181412;">
          ...
          <div class="navbar-brand ml-4 mr-3 d-flex" style="" href="#">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="music.php?style=POP">Pop</a>
                <a class="dropdown-item" href="music.php?style=HIPHOP">HipHop</a>
                <a class="dropdown-item" href="music.php?style=ROCK">Rock</a>
                <a class="dropdown-item" href="music.php?style=BALLAD">Ballad</a>
              </div>
            </div>
          </div>
          ...
          ?>  
              ...
              <a class='navbar-brand mx-4' href='./login.php'>
                <span class='mr-3' style=' color: #008800;'>
                  <i class='fas fa-circle'>
                  </i>
                </span>
                Đăng nhập
